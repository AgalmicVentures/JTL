...
class UtilityTest(unittest.TestCase):
	...
	def test_extractPath(self):
		self.assertEqual(Utility.extractPath(self._testData, 'a'), {'X': 1, 'Y': 2})
		self.assertEqual(Utility.extractPath(self._testData, 'a.X'), 1)
	...
	def test_extractSplitPath(self):
		self.assertEqual(Utility.extractSplitPath(self._testData, ['a']), {'X': 1, 'Y': 2})
		self.assertEqual(Utility.extractSplitPath(self._testData, ['a', 'X']), 1)
